...
namespace ABI.CCK.Scripts
{
    public static class CVRCommon
    {
        ...
        public const string BaseVersion = "3.15.1";
        ...
        public static string CCK_UNITYPACKAGE_NAME
            => $"CCK_{BaseVersion}_{ReleaseType}.unitypackage";
