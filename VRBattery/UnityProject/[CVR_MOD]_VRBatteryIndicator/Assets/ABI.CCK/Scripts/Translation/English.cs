...
namespace ABI.CCK.Scripts.Translation
{
    public class English
    {
        public static readonly Dictionary<string, string> Localization = new Dictionary<string, string>()
        {
            ...
            {"ABI_UI_BUILDPANEL_ACCOUNT_UPLOAD_LIMIT_AVATAR_WORLD_WARNING", "You are nearing the Private Avatars & Worlds upload limit for a non-unlocked account ({x}/{y})."},
            {"ABI_UI_BUILDPANEL_ACCOUNT_UPLOAD_LIMIT_SPAWNABLE_WARNING", "You are nearing the Private Spawnables upload limit for a non-unlocked account ({x}/{y})."},
            {"ABI_UI_BUILDPANEL_ACCOUNT_UPLOAD_LIMIT_INFO", "Public content does not count towards these limits, so please consider submitting for publication or obtaining an Unlocked account."},
            ...
            {
                "ABI_UI_BUILDPANEL_PROPS_ERROR_TOO_LARGE_TEXTURE",
                "Spawnable Objects or its children cannot contain textures larger than 8192 in resolution."
            },
            {
                "ABI_UI_BUILDPANEL_PROPS_ERROR_AUDIO_LOAD_IN_BACKGROUND",
                "Spawnable Objects or its children cannot have audio clips with load in background disabled."
            },
            {
                "ABI_UI_BUILDPANEL_PROPS_ERROR_INVALID_STREAMING_MIPMAPS",
                "Spawnable Objects or its children cannot have textures with streaming mipmaps disabled."
            },
            {
                "ABI_UI_BUILDPANEL_AVATAR_ERROR_TOO_LARGE_TEXTURE",
                "Avatar Objects or its children cannot contain textures larger than 8192 in resolution."
            },
            {
                "ABI_UI_BUILDPANEL_AVATAR_ERROR_AUDIO_LOAD_IN_BACKGROUND",
                "Avatar Objects or its children cannot have audio clips with load in background disabled."
            },
            {
                "ABI_UI_BUILDPANEL_AVATAR_ERROR_INVALID_STREAMING_MIPMAPS",
                "Avatar Objects or its children cannot have textures with streaming mipmaps disabled."
            },
            {
