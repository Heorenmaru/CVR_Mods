...
namespace ABI.CCK.Components
{
    public partial class CCK_CVRWorldEditor
    {
        ...
        private void DrawSpawnBehaviourSettings()
        {
            ...
            if (_world.objectRespawnBehaviour == CVRWorld.RespawnBehaviour.Destroy)
                EditorGUILayout.HelpBox("Object Respawn Behaviour 'Destroy' is not yet implemented.", MessageType.Warning);
        }
