        ...
        public override void OnInspectorGUI()
        {
                       ...
                       "Local Gravity", _boldFoldoutStyle))
            {
                ...
                using (new EditorGUI.DisabledGroupScope(!_influencer.enableLocalGravity))
                {
                    ...
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("gravityFactor"), new GUIContent("Gravity Factor"));
                    
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("gentleAlignUpright"), new GUIContent("Gentle Align Upright"));
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("gentleAlignSpeed"), new GUIContent("Gentle Align Speed"));
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("gentleAlignStability"), new GUIContent("Gentle Align Stability"));
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("gentleAlignAxis"), new GUIContent("Gentle Align Axis"));
                }
            }
            /*
